...
function(a, b, c, d) {
    ...
    function e(b) {
        ...
        if (this.config.longitude_range && 2 !== this.config.longitude_range.length && (this.config.longitude_range = null, console.warn("PhotoSphereViewer: longitude_range must have exactly two elements.")), this.config.latitude_range ? 2 !== this.config.latitude_range.length ? (this.config.latitude_range = null, console.warn("PhotoSphereViewer: latitude_range must have exactly two elements.")) : this.config.latitude_range[0] > this.config.latitude_range[1] && (this.config.latitude_range = [this.config.latitude_range[1], this.config.latitude_range[0]], console.warn("PhotoSphereViewer: latitude_range values must be ordered.")) : void 0 === this.config.tilt_up_max && void 0 === this.config.tilt_down_max || (this.config.latitude_range = [void 0 !== this.config.tilt_down_max ? this.config.tilt_down_max - Math.PI / 4 : -x.HalfPI, void 0 !== this.config.tilt_up_max ? this.config.tilt_up_max + Math.PI / 4 : x.HalfPI], console.warn("PhotoSphereViewer: tilt_up_max and tilt_down_max are deprecated, use latitude_range instead.")), this.config.max_fov < this.config.min_fov) {
            ...
            this.config.min_fov = c,
            console.warn("PhotoSphereViewer: max_fov cannot be lower than min_fov.")
        }
        this.config.cache_texture && (!x.isInteger(this.config.cache_texture) || this.config.cache_texture < 0) && (this.config.cache_texture = e.DEFAULTS.cache_texture, console.warn("PhotoSphreViewer: invalid valud for cache_texture")),
        ...
        this.config.default_lat = x.parseAngle(this.config.default_lat, -Math.PI),
        this.config.default_lat = x.bound(this.config.default_lat, -x.HalfPI, x.HalfPI),
        null === this.config.anim_lat ? this.config.anim_lat = this.config.default_lat: (this.config.anim_lat = x.parseAngle(this.config.anim_lat, -Math.PI), this.config.anim_lat = x.bound(this.config.anim_lat, -x.HalfPI, x.HalfPI)),
        this.config.longitude_range && (this.config.longitude_range = this.config.longitude_range.map(function(a) {
            return x.parseAngle(a)
        })),
        this.config.latitude_range && (this.config.latitude_range = this.config.latitude_range.map(function(a) {
            return a = x.parseAngle(a, -Math.PI),
            x.bound(a, -x.HalfPI, x.HalfPI)
        })),
        ...
        this.config.fisheye === !0 ? this.config.fisheye = 1 : this.config.fisheye === !1 && (this.config.fisheye = 0),
        this.parent = "string" == typeof b.container ? document.getElementById(b.container) : b.container,
        this.container = null,
        this.loader = null,
        this.navbar = null,
        this.hud = null,
        ...
        Object.keys(e.TEMPLATES).forEach(function(a) {
            this.config.templates[a] || (this.config.templates[a] = e.TEMPLATES[a]),
            "string" == typeof this.config.templates[a] && (this.config.templates[a] = d.template(this.config.templates[a]))
        },
        this),
        ...
        this.zoom(f - 2 * (f - 50), !1),
        this.prop.move_speed = a.Math.degToRad(this.config.move_speed / e.SYSTEM.pixelRatio),
        this.rotate({
        ...
        this.loader.hide(),
        this.navbar = new i(this),
        this.navbar.hide(),
        this.hud = new g(this),
        this.hud.hide(),
        this.panel = new l(this),
        this.tooltip = new m(this.hud),
        this._bindEvents(),
        this.config.autoload && this.load(),
        this.once("render",
        function() {
            this.config.navbar && (this.container.classList.add("psv-container--has-navbar"), this.navbar.show()),
            this.hud.show(),
            this.config.markers && (this.config.markers.forEach(function(a) {
                this.hud.addMarker(a, !1)
            },
            this), this.hud.renderMarkers()),
            this.config.time_anim !== !1 && (this.prop.start_timeout = window.setTimeout(this.startAutorotate.bind(this), this.config.time_anim)),
            this.trigger("ready")
        }.bind(this))
    }
    function f(a) {
        this.psv = a instanceof e ? a: a.psv,
        this.parent = a,
        this.container = null,
        this.constructor.publicMethods && this.constructor.publicMethods.forEach(function(a) {
    ...
    function v(a) {
        this.message = a,
        "captureStackTrace" in Error ? Error.captureStackTrace(this, v) : this.stack = (new Error).stack
    }
    function w(a, b) {
        ...
        c = this.isNormal() ? document.createElement("div") : this.isPolygon() ? document.createElementNS(x.svgNS, "polygon") : document.createElementNS(x.svgNS, this.type),
        c.id = "psv-marker-" + this.id,
        c.psvMarker = this,
        this.update(a)
    }
    c.mixin(e),
    e.prototype._loadXMP = function(a) {
        ...
        return d.onreadystatechange = function() {
            if (4 === d.readyState) {
                if (200 !== d.status && 201 !== d.status && 202 !== d.status && 0 !== d.status) throw e.container.textContent = "Cannot load image",
                new v("Cannot load image");
        ...
        d.onerror = function() {
            throw e.container.textContent = "Cannot load image",
            new v("Cannot load image")
        },
        d.open("GET", a, !0),
        d.send(null),
    ...
    e.prototype._loadTexture = function(a) {
        ...
        if (Array.isArray(a)) {
            ...
            this.config.cache_texture === e.DEFAULTS.cache_texture && (this.config.cache_texture *= 6),
            this.prop.isCubemap = !0,
            this._loadCubemapTexture(a)
        }
    ...
    e.prototype._loadEquirectangularTexture = function(c) {
        ...
        return this._loadXMP(c).then(function(d) {
            ...
            var i = function(b) {
                h = 100,
                this.loader.setProgress(h),
                this.trigger("panorama-load-progress", c, h),
                !d && this.config.pano_data && (d = x.clone(this.config.pano_data)),
                d || (d = {
                    full_width: b.width,
                ...
                if (1 !== i || d.cropped_width != d.full_width || d.cropped_height != d.full_height) {
                    ...
                    j.cropped_x *= i,
                    j.cropped_y *= i,
                    b.width = j.cropped_width,
                    b.height = j.cropped_height;
                    var k = document.createElement("canvas");
                    k.width = j.full_width,
                    k.height = j.full_height;
                    var l = k.getContext("2d");
                    l.drawImage(b, j.cropped_x, j.cropped_y, j.cropped_width, j.cropped_height),
                    g = new a.Texture(k)
                } else g = new a.Texture(b);
                g.needsUpdate = !0,
                g.minFilter = a.LinearFilter,
                g.generateMipmaps = !1,
            ...
            return g.load(c, i.bind(this), j.bind(this), k.bind(this)),
            f.promise
        }.bind(this))
    },
    e.prototype._loadCubemapTexture = function(c) {
        ...
        k = function(b, d) {
            i++,
            g[b] = 100,
            this.loader.setProgress(x.sum(g) / 6),
            this.trigger("panorama-load-progress", c[b], g[b]);
            ...
            if (1 !== f) {
                ...
                k.height = d.height * f;
                var l = k.getContext("2d");
                l.drawImage(d, 0, 0, k.width, k.height),
                h[b] = new a.Texture(k)
        ...
        return 6 === i && d.resolve(h),
        d.promise
    },
    e.prototype._setTexture = function(a) {
        if (this.scene || this._createScene(), this.prop.isCubemap) for (var b = 0; b < 6; b++) this.mesh.material.materials[b].map && this.mesh.material.materials[b].map.dispose(),
        this.mesh.material.materials[b].map = a[b];
        else this.mesh.material.map && this.mesh.material.map.dispose(),
        this.mesh.material.map = a;
        this.trigger("panorama-loaded"),
        this.render()
    },
    e.prototype._createScene = function() {
        this.raycaster = new a.Raycaster,
        this.renderer = e.SYSTEM.isWebGLSupported && this.config.webgl ? new a.WebGLRenderer: new a.CanvasRenderer,
        this.renderer.setSize(this.prop.size.width, this.prop.size.height),
        this.renderer.setPixelRatio(e.SYSTEM.pixelRatio);
        var b = e.SPHERE_RADIUS;
        this.prop.isCubemap && (b *= Math.sqrt(3)),
        this.config.fisheye && (b += e.SPHERE_RADIUS),
        this.camera = new a.PerspectiveCamera(this.config.default_fov, this.prop.size.width / this.prop.size.height, 1, b),
        this.camera.position.set(0, 0, 0),
        this.config.gyroscope && x.checkTHREE("DeviceOrientationControls") && (this.doControls = new a.DeviceOrientationControls(this.camera)),
    ...
    e.prototype._createCubemap = function() {
        ...
        this.mesh = new a.Mesh(b, new a.MultiMaterial(c)),
        this.mesh.position.x -= e.SPHERE_RADIUS,
        this.mesh.position.y -= e.SPHERE_RADIUS,
        this.mesh.position.z -= e.SPHERE_RADIUS,
        this.mesh.applyMatrix((new a.Matrix4).makeScale(1, 1, -1)),
        this.scene.add(this.mesh);
    ...
    e.prototype._transition = function(b, c) {
        ...
        x.animation({
            ...
            d.mesh.material.map = b,
            d.scene.remove(h),
            h.geometry.dispose(),
            h.geometry = null,
            h.material.dispose(),
            h.material = null,
            c ? ((d.config.latitude_range || d.config.longitude_range) && (d.config.longitude_range = d.config.latitude_range = null, console.warn("PhotoSphereViewer: trying to perform transition with longitude_range and/or latitude_range, ranges cleared.")), d.rotate(c)) : d.render()
        })
    },
    e.prototype._reverseAutorotate = function() {
        ...
        x.animation({
            ...
            a.config.longitude_range = c,
            a.config.anim_speed = b
        })
    },
    e.prototype._putPanoramaCache = function(a) {
        ...
        b ? (b.image = a.image, b.pano_data = a.pano_data) : (this.prop.cache = this.prop.cache.slice(0, this.config.cache_texture - 1), this.prop.cache.unshift(a)),
        this.trigger("panorama-cached", a.panorama)
    },
    ...
    e.MOVE_THRESHOLD = 4,
    e.DBLCLICK_DELAY = 300,
    e.INERTIA_WINDOW = 300,
    e.SPHERE_RADIUS = 100,
    e.SPHERE_VERTICES = 64,
    e.CUBE_VERTICES = 8,
    e.CUBE_MAP = [0, 2, 4, 5, 3, 1],
    e.CUBE_HASHMAP = ["left", "right", "top", "bottom", "back", "front"],
    e.KEYMAP = {
        33 : "PageUp",
        34 : "PageDown",
        37 : "ArrowLeft",
    ...
    e.prototype._startZoom = function(a) {
        ...
        this.prop.pinch_dist = Math.sqrt(Math.pow(b[0].x - b[1].x, 2) + Math.pow(b[0].y - b[1].y, 2)),
        this.prop.moving = !1,
        this.prop.zooming = !0
    },
    ...
    e.prototype._zoom = function(a) {
        if (this.prop.zooming) {
            ...
            this.zoom(this.prop.zoom_lvl + d),
            this.prop.pinch_dist = c
        }
    },
    ...
    e.prototype._fullscreenToggled = function() {
        ...
        this.config.keyboard && (a ? this.startKeyboardControl() : this.stopKeyboardControl()),
        this.trigger("fullscreen-updated", a)
    },
    e.prototype._logMouseMove = function(a) {
        var b = Date.now();
        this.prop.mouse_history.push([b, a.clientX, a.clientY]);
        for (var c = null,
        d = 0; d < this.prop.mouse_history.length;) this.prop.mouse_history[0][d] < b - e.INERTIA_WINDOW ? this.prop.mouse_history.splice(d, 1) : c && this.prop.mouse_history[0][d] - c > e.INERTIA_WINDOW / 10 ? (this.prop.mouse_history.splice(0, d), d = 0, c = this.prop.mouse_history[0][d]) : (d++, c = this.prop.mouse_history[0][d])
    },
    ...
    e.prototype.render = function(a) {
        a !== !1 && (this.prop.direction = this.sphericalCoordsToVector3(this.prop), this.camera.position.set(0, 0, 0), this.camera.lookAt(this.prop.direction)),
    ...
    e.prototype.destroy = function() {
        ...
        this.isFullscreenEnabled() && x.exitFullscreen(),
        window.removeEventListener("resize", this),
        this.config.mousemove && (this.hud.container.removeEventListener("mousedown", this), this.hud.container.removeEventListener("touchstart", this), window.removeEventListener("mouseup", this), window.removeEventListener("touchend", this), this.hud.container.removeEventListener("mousemove", this), this.hud.container.removeEventListener("touchmove", this)),
        e.SYSTEM.fullscreenEvent && document.removeEventListener(e.SYSTEM.fullscreenEvent, this),
        this.config.mousewheel && this.hud.container.removeEventListener(e.SYSTEM.mouseWheelEvent, this),
    ...
    e.prototype.setPanorama = function(a, b, c) {
        ...
        b && (this.cleanPosition(b), this._stopAll()),
        this.config.panorama = a;
        var d = this;
        return c && this.config.transition && this.scene ? (this.config.transition.loader && this.loader.show(), this.prop.loading_promise = this._loadTexture(this.config.panorama).then(function(a) {
            ...
            d.loader.hide(),
            d.canvas_container.style.opacity = 1,
            d.prop.loading_promise = null
        }).rethrow()),
    ...
    e.prototype.stopAutorotate = function() {
        this.prop.start_timeout && (window.clearTimeout(this.prop.start_timeout), this.prop.start_timeout = null),
        this.prop.autorotate_reqid && (window.cancelAnimationFrame(this.prop.autorotate_reqid), this.prop.autorotate_reqid = null, this.trigger("autorotate", !1))
    },
    ...
    e.prototype.startGyroscopeControl = function() {
        ...
        function b() {
            a.doControls.update(),
            a.prop.direction = a.camera.getWorldDirection();
            var c = a.vector3ToSphericalCoords(a.prop.direction);
            a.prop.longitude = c.longitude,
            a.prop.latitude = c.latitude,
            a.render(!1),
            a.prop.orientation_reqid = window.requestAnimationFrame(b)
        } (),
    ...
    e.prototype.rotate = function(a, b) {
        this.cleanPosition(a),
        this.applyRanges(a).forEach(this.trigger.bind(this, "_side-reached")),
        this.prop.longitude = a.longitude,
        this.prop.latitude = a.latitude,
        b !== !1 && this.renderer && (this.render(), this.trigger("position-updated", this.getPosition()))
    },
    e.prototype.animate = function(a, c) {
        if (this._stopAll(), !c) return this.rotate(a),
        b.resolved();
    ...
    e.prototype.zoom = function(b, c) {
        this.prop.zoom_lvl = x.bound(Math.round(b), 0, 100),
        this.prop.vFov = this.config.max_fov + this.prop.zoom_lvl / 100 * (this.config.min_fov - this.config.max_fov),
        this.prop.hFov = a.Math.radToDeg(2 * Math.atan(Math.tan(a.Math.degToRad(this.prop.vFov) / 2) * this.prop.aspect)),
        c !== !1 && this.renderer && (this.render(), this.trigger("zoom-updated", this.getZoomLevel()))
    },
    ...
    e.prototype.clearPanoramaCache = function(a) {
        ...
        if (a) {
            for (var b = 0,
            c = this.prop.cache.length; b < c; b++) if (this.prop.cache[b].panorama === a) {
    ...
    e._loadSystem = function() {
        ...
        a.isWebGLSupported = x.isWebGLSupported(),
        a.isCanvasSupported = x.isCanvasSupported(),
        a.maxTextureWidth = a.isWebGLSupported ? x.getMaxTextureWidth() : 4096,
        a.mouseWheelEvent = x.mouseWheelEvent(),
        a.fullscreenEvent = x.fullscreenEvent(),
        a.deviceOrientationSupported = b(),
        "DeviceOrientationEvent" in window ? window.addEventListener("deviceorientation", e._deviceOrientationListener, !1) : a.deviceOrientationSupported.reject()
    },
    e._deviceOrientationListener = function(a) {
        null === a.alpha || isNaN(a.alpha) ? e.SYSTEM.deviceOrientationSupported.reject() : e.SYSTEM.deviceOrientationSupported.resolve(),
        window.removeEventListener("deviceorientation", e._deviceOrientationListener)
    },
    e.prototype._setViewerSize = function(a) { ["width", "height"].forEach(function(b) {
    ...
    e.prototype.cleanPosition = function(a) {
        a.hasOwnProperty("x") && a.hasOwnProperty("y") && x.deepmerge(a, this.textureCoordsToSphericalCoords(a)),
        a.longitude = x.parseAngle(a.longitude),
        a.latitude = x.bound(x.parseAngle(a.latitude, -Math.PI), -x.HalfPI, x.HalfPI)
    },
    e.prototype.applyRanges = function(b) {
        var c, d, e = [];
        return this.config.longitude_range && (c = x.clone(this.config.longitude_range), d = a.Math.degToRad(this.prop.hFov) / 2, c[0] = x.parseAngle(c[0] + d), c[1] = x.parseAngle(c[1] - d), c[0] > c[1] ? b.longitude > c[1] && b.longitude < c[0] && (b.longitude > c[0] / 2 + c[1] / 2 ? (b.longitude = c[0], e.push("left")) : (b.longitude = c[1], e.push("right"))) : b.longitude < c[0] ? (b.longitude = c[0], e.push("left")) : b.longitude > c[1] && (b.longitude = c[1], e.push("right"))),
        this.config.latitude_range && (c = x.clone(this.config.latitude_range), d = a.Math.degToRad(this.prop.vFov) / 2, c[0] = x.parseAngle(Math.min(c[0] + d, c[1]), -Math.PI), c[1] = x.parseAngle(Math.max(c[1] - d, c[0]), -Math.PI), b.latitude < c[0] ? (b.latitude = c[0], e.push("bottom")) : b.latitude > c[1] && (b.latitude = c[1], e.push("top"))),
        e
    },
    f.className = null,
    f.publicMethods = [],
    ...
    g.className = "psv-hud",
    g.publicMethods = ["addMarker", "removeMarker", "updateMarker", "clearMarkers", "getMarker", "getCurrentMarker", "gotoMarker", "hideMarker", "showMarker", "toggleMarker", "toggleMarkersList", "showMarkersList", "hideMarkersList"],
    ...
    g.prototype.addMarker = function(a, b) {
        ...
        return c.isNormal() ? this.container.appendChild(c.$el) : this.svgContainer.appendChild(c.$el),
        this.markers[c.id] = c,
        b !== !1 && this.renderMarkers(),
        c
    },
    ...
    g.prototype.removeMarker = function(a, b) {
        a = this.getMarker(a),
        a.isNormal() ? this.container.removeChild(a.$el) : this.svgContainer.removeChild(a.$el),
        this.hoveringMarker == a && this.psv.tooltip.hideTooltip(),
        a.destroy(),
        delete this.markers[a.id],
        b !== !1 && this.renderMarkers()
    },
    g.prototype.clearMarkers = function(a) {
        ...
        this),
        a !== !1 && this.renderMarkers()
    },
    g.prototype.gotoMarker = function(a, b) {
        return a = this.getMarker(a),
        this.psv.animate(a, b)
    },
    g.prototype.hideMarker = function(a) {
        this.getMarker(a).visible = !1,
        this.renderMarkers()
    },
    g.prototype.showMarker = function(a) {
        this.getMarker(a).visible = !0,
        this.renderMarkers()
    },
    ...
    g.prototype._getMarkerPosition = function(a) {
        if (a._dynamicSize) {
            ...
            x.toggleClass(a.$el, "psv-marker--transparent", !1),
            a.width = b.right - b.left,
            a.height = b.bottom - b.top
        }
        var c = this.psv.vector3ToViewerCoords(a.position3D);
        return c.x -= a.width * a.anchor.left,
        c.y -= a.height * a.anchor.top,
        c
    },
    ...
    g.prototype._onMouseLeave = function(a) {
        ...
        if (a.target && (b = a.target.psvMarker)) {
            ...
            this.psv.trigger("leave-marker", b),
            this.hoveringMarker = null,
    ...
    g.prototype._onPanelOpened = function() {
        this.prop.panelOpening ? (this.prop.panelOpening = !1, this.prop.panelOpened = !0) : this.prop.panelOpened = !1,
    ...
    h.className = "psv-loader-container",
    ...
    h.prototype.setProgress = function(a) {
        ...
        b.lineWidth = this.tickness,
        b.strokeStyle = x.getStyle(this.loader, "color"),
        b.beginPath(),
        b.arc(this.canvas.width / 2, this.canvas.height / 2, this.canvas.width / 2 - this.tickness / 2, -Math.PI / 2, a / 100 * 2 * Math.PI - Math.PI / 2),
        b.stroke()
    },
    i.prototype = Object.create(f.prototype),
    i.prototype.constructor = i,
    i.className = "psv-navbar psv-navbar--open",
    i.publicMethods = ["showNavbar", "hideNavbar", "toggleNavbar", "getNavbarButton"],
    i.prototype.create = function() {
        f.prototype.create.call(this),
        this.config.forEach(function(a) {
    ...
    i.prototype.getNavbarButton = function(a) {
        ...
        b || console.warn('PhotoSphereViewer: button "' + a + '" not found in the navbar.'),
        b
    },
    ...
    j.className = "psv-caption",
    j.publicMethods = ["setCaption"],
    j.prototype.setCaption = function(a) {
        a ? this.container.innerHTML = a: this.container.innerHTML = ""
    },
    k.prototype = Object.create(f.prototype),
    k.prototype.constructor = k,
    k.className = "psv-spacer",
    ...
    l.prototype.create = function() {
        ...
        a.addEventListener("click", this.hidePanel.bind(this)),
        this.psv.config.mousewheel && this.container.addEventListener(e.SYSTEM.mouseWheelEvent,
        function(a) {
            a.stopPropagation()
        });
    ...
    l.prototype.showPanel = function(a, b) {
        ...
        x.toggleClass(this.content, "psv-panel-content--no-margin", !!b),
        this.prop.opened = !0,
    ...
    l.prototype._onTouchStart = function(a) {
        a.stopPropagation(),
        this._startResize(a.changedTouches[0])
    },
    ...
    l.prototype._startResize = function(a) {
        this.prop.mouse_x = parseInt(a.clientX),
        this.prop.mouse_y = parseInt(a.clientY),
    ...
    l.prototype._resize = function(a) {
        ...
        this.container.style.width = this.container.offsetWidth - (b - this.prop.mouse_x) + "px",
        this.prop.mouse_x = b,
        this.prop.mouse_y = c
    },
    m.prototype = Object.create(f.prototype),
    m.prototype.constructor = m,
    m.className = "psv-tooltip",
    m.publicMethods = ["showTooltip", "hideTooltip", "isTooltipVisible"],
    m.leftMap = {
        0 : "left",
        .5 : "center",
        1 : "right"
    ...
    m.prototype.showTooltip = function(a) {
        ...
        a.className && x.addClasses(c, a.className),
        d.innerHTML = a.content,
        c.style.top = "0px",
        c.style.left = "0px";
        ...
        if (j.top < this.config.offset ? (j.posClass[0] = "bottom", k = !0) : j.top + j.height > this.psv.prop.size.height - this.config.offset && (j.posClass[0] = "top", k = !0), j.left < this.config.offset ? (j.posClass[1] = "right", k = !0) : j.left + j.width > this.psv.prop.size.width - this.config.offset && (j.posClass[1] = "left", k = !0), k && this._computeTooltipPosition(j, a), c.style.top = j.top + "px", c.style.left = j.left + "px", e.style.top = j.arrow_top + "px", e.style.left = j.arrow_left + "px", c.classList.add("psv-tooltip--" + j.posClass.join("-")), !b) {
            ...
            this.prop.timeout = window.setTimeout(function() {
                c.classList.add("psv-tooltip--visible"),
                l.prop.timeout = null,
                l.psv.trigger("show-tooltip")
            },
            this.config.delay)
        }
    },
    m.prototype.hideTooltip = function() {
        if (this.prop.timeout && (window.clearTimeout(this.prop.timeout), this.prop.timeout = null), this.isTooltipVisible()) {
            ...
            var a = this;
            this.prop.timeout = window.setTimeout(function() {
                a.content.innerHTML = null,
                a.container.style.top = "-1000px",
                a.container.style.left = "-1000px",
                a.prop.timeout = null
            },
            this.config.delay),
    ...
    m.prototype._computeTooltipPosition = function(a, b) {
        ...
        switch (a.posClass[0]) {
        case "bottom":
            a.top = b.top + b.box.height + this.config.offset + this.config.arrow_size,
            a.arrow_top = 2 * -this.config.arrow_size,
            c = !0;
            break;
        case "center":
            a.top = b.top + b.box.height / 2 - a.height / 2,
            a.arrow_top = a.height / 2 - this.config.arrow_size;
            break;
        case "top":
            a.top = b.top - a.height - this.config.offset - this.config.arrow_size,
            a.arrow_top = a.height,
            c = !0
        }
        switch (a.posClass[1]) {
        case "right":
            ...
            break;
        case "center":
            a.left = b.left + b.box.width / 2 - a.width / 2,
            a.arrow_left = a.width / 2 - this.config.arrow_size;
            break;
        case "left":
    ...
    n.prototype.toggleActive = function(a) {
        x.toggleClass(this.container, "psv-button--active", a),
        this.constructor.iconActive && this._setIcon(a ? this.constructor.iconActive: this.constructor.icon)
    },
    ...
    n.prototype._setIcon = function(a, b) {
        b || (b = this.container),
        a ? (b.innerHTML = e.ICONS[a], b.querySelector("svg").setAttribute("class", "psv-button-svg")) : b.innerHTML = ""
    },
    n.prototype._onClick = function() {},
    o.prototype = Object.create(n.prototype),
    o.prototype.constructor = o,
    o.id = "autorotate",
    o.className = "psv-button psv-button--hover-scale psv-autorotate-button",
    o.icon = "play.svg",
    o.iconActive = "play-active.svg",
    ...
    p.className = "psv-button psv-custom-button",
    p.prototype.create = function() {
        ...
        this.config.enabled !== !1 && this.config.disabled !== !0 || this.disable(),
        this.config.visible !== !1 && this.config.hidden !== !0 || this.hide()
    },
    ...
    q.id = "download",
    q.className = "psv-button psv-button--hover-scale psv-download-button",
    q.icon = "download.svg",
    q.prototype._onClick = function() {
        var a = document.createElement("a");
        a.href = this.psv.config.panorama,
        a.download = this.psv.config.panorama,
        this.psv.container.appendChild(a),
        a.click()
    },
    r.prototype = Object.create(n.prototype),
    r.prototype.constructor = r,
    r.id = "fullscreen",
    r.className = "psv-button psv-button--hover-scale psv-fullscreen-button",
    r.icon = "fullscreen-in.svg",
    r.iconActive = "fullscreen-out.svg",
    r.prototype.create = function() {
        n.prototype.create.call(this),
        e.SYSTEM.fullscreenEvent || (this.hide(), console.warn("PhotoSphereViewer: fullscreen not supported.")),
    ...
    s.id = "gyroscope",
    s.className = "psv-button psv-button--hover-scale psv-gyroscope-button",
    s.icon = "compass.svg",
    s.prototype.create = function() {
        n.prototype.create.call(this),
        e.SYSTEM.deviceOrientationSupported.promise.then(this._onAvailabilityChange.bind(this, !0), this._onAvailabilityChange.bind(this, !1)),
        this.hide(),
    ...
    t.id = "markers",
    t.className = "psv-button psv-button--hover-scale psv-markers-button",
    t.icon = "pin.svg",
    ...
    u.id = "zoom",
    u.className = "psv-button psv-zoom-button",
    u.prototype.create = function() {
        n.prototype.create.call(this);
        var a = document.createElement("div");
        a.className = "psv-zoom-button-minus",
        a.title = this.psv.config.lang.zoomOut,
        this._setIcon("zoom-out.svg", a),
        this.container.appendChild(a);
        var b = document.createElement("div");
        b.className = "psv-zoom-button-range",
        this.container.appendChild(b),
        this.zoom_range = document.createElement("div"),
        this.zoom_range.className = "psv-zoom-button-line",
        b.appendChild(this.zoom_range),
        ...
        c.className = "psv-zoom-button-plus",
        c.title = this.psv.config.lang.zoomIn,
        ...
        this.psv.container.addEventListener("mouseup", this),
        this.psv.container.addEventListener("touchend", this),
        a.addEventListener("mousedown", this._zoomOut.bind(this)),
        c.addEventListener("mousedown", this._zoomIn.bind(this)),
    ...
    v.prototype.name = "PSVError",
    v.prototype.constructor = v,
    e.Error = v,
    w.types = ["image", "html", "polygon_px", "polygon_rad", "rect", "circle", "ellipse", "path"],
    w.getType = function(a, b) {
        var c = [];
    ...
    w.prototype.update = function(a) {
        ...
        this.tooltip && (x.addClasses(this.$el, "has-tooltip"), "string" == typeof this.tooltip && (this.tooltip = {
    ...
    w.prototype._updateNormal = function() {
        this.width && this.height ? (this.$el.style.width = this.width + "px", this.$el.style.height = this.height + "px", this._dynamicSize = !1) : this._dynamicSize = !0,
    ...
    w.prototype._updateSvg = function() {
        ...
        this),
        this.svgStyle ? Object.getOwnPropertyNames(this.svgStyle).forEach(function(a) {
    ...
    w.prototype._updatePolygon = function() {
        ...
        this) : this.$el.setAttributeNS(null, "fill", "rgba(0,0,0,0.5)"),
        [this.polygon_rad, this.polygon_px].forEach(function(a) {
        ...
        this.positions3D = this.polygon_rad.map(function(a) {
    ...
    x.checkTHREE = function(b) {
        for (var c = 0,
        d = arguments.length; c < d; c++) if (! (arguments[c] in a)) return ! 1;
        return ! 0
    },
    ...
    x.getWebGLCtx = function() {
        ...
        return a.getContext && b.some(function(b) {
            try {
                return c = a.getContext(b),
                c && "function" == typeof c.getParameter
            } catch(d) {
                return ! 1
            }
        }) ? c: null
    ...
    x.toggleClass = function(a, b, c) {
        if (a.classList) void 0 === c ? a.classList.toggle(b) : c && !a.classList.contains(b) ? a.classList.add(b) : c || a.classList.remove(b);
            ...
            e = d.indexOf(b) !== -1,
            f = new RegExp("(?:^|\\s)" + b + "(?:\\s|$)");
            void 0 !== c && !c || e ? c || (d = d.replace(f, " ")) : d += d.length > 0 ? " " + b: b,
    ...
    x.requestFullscreen = function(a) { (a.requestFullscreen || a.mozRequestFullScreen || a.webkitRequestFullscreen || a.msRequestFullscreen).call(a)
    },
    x.exitFullscreen = function() { (document.exitFullscreen || document.mozCancelFullScreen || document.webkitExitFullscreen || document.msExitFullscreen).call(document)
    },
    ...
    x.parseAngle = function(b, c) {
        ...
        return c !== !1 && (void 0 === c && (c = 0), b = (b - c) % x.TwoPI, b < 0 && (b = x.TwoPI + b), b += c),
        b
    },
    x.cleanTHREEScene = function(b) {
        b.children.forEach(function(b) {
            b instanceof a.Mesh && (b.geometry && (b.geometry.dispose(), b.geometry = null), b.material && (b.material.materials ? (b.material.materials.forEach(function(a) {
                a.map && (a.map.dispose(), a.map = null),
                a.dispose()
    ...
    x.animation = function(a) {
        ...
        var d = b(!1),
        e = null;
        a.easing && "string" != typeof a.easing || (a.easing = x.animation.easings[a.easing || "linear"]),
        void 0 !== a.delay ? window.setTimeout(function() {
            window.requestAnimationFrame(c)
        },
    ...
    x.animation.easings = {
        ...
        inOutExpo: function(a) {
            return a = 2 * a - 1,
            a < 0 ? .5 * Math.pow(2, 10 * a) : 1 - .5 * Math.pow(2, -10 * a)
        },
        inCirc: function(a) {
        ...
        inOutCirc: function(a) {
            return a *= 2,
            a < 1 ? .5 - .5 * Math.sqrt(1 - a * a) : .5 + .5 * Math.sqrt(1 - (a -= 2) * a)
        }
    },
    x.throttle = function(a, b) {
        ...
        return function() {
            ...
            return c = this,
            d = arguments,
            j <= 0 || j > b ? (f && (clearTimeout(f), f = null), g = i, e = a.apply(c, d), f || (c = d = null)) : f || (f = setTimeout(h, j)),
            e
        }
    },
    ...
    e.ICONS["compass.svg"] = '<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 100 100" enable-background="new 0 0 100 100" xml:space="preserve"><path d="M49.997,0C22.38,0.004,0.005,22.383,0,50.002C0.005,77.614,22.38,99.995,49.997,100C77.613,99.995,99.996,77.614,100,50.002C99.996,22.383,77.613,0.004,49.997,0z M49.997,88.81c-21.429-0.04-38.772-17.378-38.809-38.807c0.037-21.437,17.381-38.775,38.809-38.812C71.43,11.227,88.769,28.567,88.81,50.002C88.769,71.432,71.43,88.77,49.997,88.81z"/><path d="M72.073,25.891L40.25,41.071l-0.003-0.004l-0.003,0.009L27.925,74.109l31.82-15.182l0.004,0.004l0.002-0.007l-0.002-0.004L72.073,25.891z M57.837,54.411L44.912,42.579l21.092-10.062L57.837,54.411z"/><!--Created by iconoci from the Noun Project--></svg>',
    e.ICONS["download.svg"] = '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 100 100" enable-background="new 0 0 100 100" xml:space="preserve"><path d="M83.285,35.575H66.271L66.277,3H32.151v32.575H16.561l33.648,32.701L83.285,35.575z"/><path d="M83.316,64.199v16.32H16.592v-16.32H-0.094v32.639H100V64.199H83.316z"/><!--Created by Michael Zenaty from the Noun Project--></svg>',
    e.ICONS["fullscreen-in.svg"] = '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 100 100" enable-background="new 0 0 100 100" xml:space="preserve"><polygon points="100,39.925 87.105,39.925 87.105,18.895 66.075,18.895 66.075,6 100,6"/><polygon points="100,93.221 66.075,93.221 66.075,80.326 87.105,80.326 87.105,59.295 100,59.295"/><polygon points="33.925,93.221 0,93.221 0,59.295 12.895,59.295 12.895,80.326 33.925,80.326"/><polygon points="12.895,39.925 0,39.925 0,6 33.925,6 33.925,18.895 12.895,18.895"/><!--Created by Garrett Knoll from the Noun Project--></svg>',
    e.ICONS["fullscreen-out.svg"] = '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 100 100" enable-background="new 0 0 100 100" xml:space="preserve"><polygon points="66.075,7 78.969,7 78.969,28.031 100,28.031 100,40.925 66.075,40.925"/><polygon points="66.075,60.295 100,60.295 100,73.19 78.969,73.19 78.969,94.221 66.075,94.221"/><polygon points="0,60.295 33.925,60.295 33.925,94.221 21.031,94.221 21.031,73.19 0,73.19"/><polygon points="21.031,7 33.925,7 33.925,40.925 0,40.925 0,28.031 21.031,28.031"/><!--Created by Garrett Knoll from the Noun Project--></svg>',
    e.ICONS["pin.svg"] = '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 48 48" enable-background="new 0 0 48 48" xml:space="preserve"><path d="M24,0C13.798,0,5.499,8.3,5.499,18.501c0,10.065,17.57,28.635,18.318,29.421C23.865,47.972,23.931,48,24,48s0.135-0.028,0.183-0.078c0.748-0.786,18.318-19.355,18.318-29.421C42.501,8.3,34.202,0,24,0z M24,7.139c5.703,0,10.342,4.64,10.342,10.343c0,5.702-4.639,10.342-10.342,10.342c-5.702,0-10.34-4.64-10.34-10.342C13.66,11.778,18.298,7.139,24,7.139z"/><!--Created by Daniele Marucci from the Noun Project--></svg>',
    e.ICONS["play-active.svg"] = '<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 41 41" enable-background="new 0 0 41 41" xml:space="preserve"><path d="M40.5,14.1c-0.1-0.1-1.2-0.5-2.898-1C37.5,13.1,37.4,13,37.4,12.9C34.5,6.5,28,2,20.5,2S6.6,6.5,3.7,12.9c0,0.1-0.1,0.1-0.2,0.2c-1.7,0.6-2.8,1-2.9,1L0,14.4v12.1l0.6,0.2c0.1,0,1.1,0.399,2.7,0.899c0.1,0,0.2,0.101,0.2,0.199C6.3,34.4,12.9,39,20.5,39c7.602,0,14.102-4.6,16.9-11.1c0-0.102,0.1-0.102,0.199-0.2c1.699-0.601,2.699-1,2.801-1l0.6-0.3V14.3L40.5,14.1z M6.701,11.5C9.7,7,14.8,4,20.5,4c5.8,0,10.9,3,13.8,7.5c0.2,0.3-0.1,0.6-0.399,0.5c-3.799-1-8.799-2-13.6-2c-4.7,0-9.5,1-13.2,2C6.801,12.1,6.601,11.8,6.701,11.5z M25.1,20.3L18.7,24c-0.3,0.2-0.7,0-0.7-0.5v-7.4c0-0.4,0.4-0.6,0.7-0.4 l6.399,3.8C25.4,19.6,25.4,20.1,25.1,20.3z M34.5,29.201C31.602,33.9,26.4,37,20.5,37c-5.9,0-11.1-3.1-14-7.898c-0.2-0.302,0.1-0.602,0.4-0.5c3.9,1,8.9,2.1,13.6,2.1c5,0,9.9-1,13.602-2C34.4,28.602,34.602,28.9,34.5,29.201z"/><!--Created by Nick Bluth from the Noun Project--></svg>',
    e.ICONS["play.svg"] = '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 41 41" enable-background="new 0 0 41 41" xml:space="preserve"><path d="M40.5,14.1c-0.1-0.1-1.2-0.5-2.899-1c-0.101,0-0.2-0.1-0.2-0.2C34.5,6.5,28,2,20.5,2S6.6,6.5,3.7,12.9c0,0.1-0.1,0.1-0.2,0.2c-1.7,0.6-2.8,1-2.9,1L0,14.4v12.1l0.6,0.2c0.1,0,1.1,0.4,2.7,0.9c0.1,0,0.2,0.1,0.2,0.199C6.3,34.4,12.9,39,20.5,39c7.601,0,14.101-4.6,16.9-11.1c0-0.101,0.1-0.101,0.2-0.2c1.699-0.6,2.699-1,2.8-1l0.6-0.3V14.3L40.5,14.1zM20.5,4c5.8,0,10.9,3,13.8,7.5c0.2,0.3-0.1,0.6-0.399,0.5c-3.8-1-8.8-2-13.6-2c-4.7,0-9.5,1-13.2,2c-0.3,0.1-0.5-0.2-0.4-0.5C9.7,7,14.8,4,20.5,4z M20.5,37c-5.9,0-11.1-3.1-14-7.899c-0.2-0.301,0.1-0.601,0.4-0.5c3.9,1,8.9,2.1,13.6,2.1c5,0,9.9-1,13.601-2c0.3-0.1,0.5,0.2,0.399,0.5C31.601,33.9,26.4,37,20.5,37z M39.101,24.9c0,0.1-0.101,0.3-0.2,0.3c-2.5,0.9-10.4,3.6-18.4,3.6c-7.1,0-15.6-2.699-18.3-3.6C2.1,25.2,2,25,2,24.9V16c0-0.1,0.1-0.3,0.2-0.3c2.6-0.9,10.6-3.6,18.2-3.6c7.5,0,15.899,2.7,18.5,3.6c0.1,0,0.2,0.2,0.2,0.3V24.9z"/><path d="M18.7,24l6.4-3.7c0.3-0.2,0.3-0.7,0-0.8l-6.4-3.8c-0.3-0.2-0.7,0-0.7,0.4v7.4C18,24,18.4,24.2,18.7,24z"/><!--Created by Nick Bluth from the Noun Project--></svg>',
    e.ICONS["zoom-in.svg"] = '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 20 20" enable-background="new 0 0 20 20" xml:space="preserve"><path d="M14.043,12.22c2.476-3.483,1.659-8.313-1.823-10.789C8.736-1.044,3.907-0.228,1.431,3.255c-2.475,3.482-1.66,8.312,1.824,10.787c2.684,1.908,6.281,1.908,8.965,0l4.985,4.985c0.503,0.504,1.32,0.504,1.822,0c0.505-0.503,0.505-1.319,0-1.822L14.043,12.22z M7.738,13.263c-3.053,0-5.527-2.475-5.527-5.525c0-3.053,2.475-5.527,5.527-5.527c3.05,0,5.524,2.474,5.524,5.527C13.262,10.789,10.788,13.263,7.738,13.263z"/><polygon points="8.728,4.009 6.744,4.009 6.744,6.746 4.006,6.746 4.006,8.73 6.744,8.73 6.744,11.466 8.728,11.466 8.728,8.73 11.465,8.73 11.465,6.746 8.728,6.746"/><!--Created by Ryan Canning from the Noun Project--></svg>',
    e.ICONS["zoom-out.svg"] = '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 20 20" enable-background="new 0 0 20 20" xml:space="preserve"><path d="M14.043,12.22c2.476-3.483,1.659-8.313-1.823-10.789C8.736-1.044,3.907-0.228,1.431,3.255c-2.475,3.482-1.66,8.312,1.824,10.787c2.684,1.908,6.281,1.908,8.965,0l4.985,4.985c0.503,0.504,1.32,0.504,1.822,0c0.505-0.503,0.505-1.319,0-1.822L14.043,12.22z M7.738,13.263c-3.053,0-5.527-2.475-5.527-5.525c0-3.053,2.475-5.527,5.527-5.527c3.05,0,5.524,2.474,5.524,5.527C13.262,10.789,10.788,13.263,7.738,13.263z"/><rect x="4.006" y="6.746" width="7.459" height="1.984"/><!--Created by Ryan Canning from the Noun Project--></svg>',
    e
});